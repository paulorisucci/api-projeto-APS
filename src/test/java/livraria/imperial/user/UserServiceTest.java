...
//
//        UserEntity updatedUser = userService.partialUpdate(updateUserRequest);
//
//        //Then
//        SoftAssertions.assertSoftly(softly -> {
...
//
//        //Then
//        Assertions.assertThatThrownBy(() -> userService.partialUpdate(updateUserRequest)).isInstanceOf(EntityNotFoundException.class);
//        Mockito.verify(userRepository, Mockito.times(0)).save(Mockito.any(UserEntity.class));
//    }
//
//    @Test
